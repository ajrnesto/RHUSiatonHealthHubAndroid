...
public class Utils {
    ...
    public static void newPatientDialog(Context context){
        MaterialAlertDialogBuilder dialogLoginRequired = new MaterialAlertDialogBuilder(context);
        dialogLoginRequired.setTitle("Are you a new patient?");
        dialogLoginRequired.setMessage("Do you have an existing RHU Siaton Healthhub account?");
        dialogLoginRequired.setPositiveButton("Yes", (dialogInterface, i) -> {
            Intent iAuth = new Intent(context, AuthenticationActivity.class);
            iAuth.putExtra("user_has_account", true);
            context.startActivity(iAuth);
        });
        dialogLoginRequired.setNegativeButton("No", (dialogInterface, i) -> {
            Intent iAuth = new Intent(context, AuthenticationActivity.class);
            iAuth.putExtra("user_has_account", false);
            context.startActivity(iAuth);
        });
        dialogLoginRequired.setNeutralButton("Back", (dialogInterface, i) -> { });
